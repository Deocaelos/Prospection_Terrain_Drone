...
import com.xpfriend.tydrone.telloio.handlers.FlipHandler;
...
public class MessageHandlerManager {
    ...
    private int Index_Drone = 0;
    private String AddrInterfaceWLAN = null;

    public MessageHandlerManager(OutputStreamFactory outputStreamFactory, Logger logger, String _Inet4Address, int _Index) throws IOException {
        this.logger = logger;
        this.AddrInterfaceWLAN = _Inet4Address;
        this.Index_Drone = _Index;
        ...
        addHandler(new FlipHandler(), new String[]{"flip"}, new int[]{});
    ...
    public DatagramChannel connect() throws IOException, InterruptedException {
    	System.out.println("Adresse: "+this.AddrInterfaceWLAN);
        channel = DatagramChannel.open().bind(new InetSocketAddress(Inet4Address.getByName(this.AddrInterfaceWLAN),9000+this.Index_Drone));
