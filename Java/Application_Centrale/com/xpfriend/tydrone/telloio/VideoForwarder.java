...
public class VideoForwarder extends Startable {
    ...
    private int IndiceDrone = 0;
    private String AddrInterfaceWLAN = null;

    public VideoForwarder(DatagramChannel commandChannel, int _Indice, String AddrInterface) 
    {
    	this.IndiceDrone = _Indice;
    	this.AddrInterfaceWLAN = AddrInterface;
    ...
    public void start(Info info) throws Exception {
        ...
        try (DatagramChannel channel = DatagramChannel.open(); DatagramChannel forward = DatagramChannel.open()) {
            channel.bind(new InetSocketAddress(Inet4Address.getByName(this.AddrInterfaceWLAN),6038));
            ...
            InetSocketAddress videoPort = new InetSocketAddress("127.0.0.1", 11111+this.IndiceDrone);
